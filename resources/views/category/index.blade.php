...
@section('content')
    ...
    <div class="bg-white bg-opacity-50 p-5 rounded-lg dark:bg-slate-900 dark:bg-opacity-80 mx-auto max-w-xl">
        <h3 class="text-center uppercase py-6 text-4xl font-bold dark:text-white">Event Category</h3>
        ...
        <a href="{{ route('category.create') }}"
            ...
            <span class="w-full">Insert new Category</span>
            ...
            <tbody>
                @foreach ($categories as $cate)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                        ...
                        <td class="">
                            <form class="inline" action="{{ route('category.edit') }}" method="POST">
                                @csrf
                            ...
                            <form class="inline" action="{{ route('category.delete') }}" method="POST">
                                @csrf
                                <input type="hidden" name="category_id" value="{{ $cate->id }}">
