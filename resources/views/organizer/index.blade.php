...
@section('content')
    ...
    <div class="bg-white bg-opacity-50 p-5 rounded-lg dark:bg-slate-900 dark:bg-opacity-80">
        <h3 class="text-center uppercase pt-6 pb-2 text-4xl font-bold dark:text-white">Organizer</h3>
        ...
        <a href="{{ route('organizer.create') }}"
            ...
            <span class="w-full">Insert new Organizer</span>
                ...
                @foreach ($organizers as $org)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                        ...
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="{{ route('organizer.detail', $org->id) }}">{{ $org->name }}</a>
                        </td>
                        <td class="font-normal text-gray-900 whitespace-nowrap dark:text-white">
                            @php
                                $description = Illuminate\Support\Str::limit($org->description, 80, '...');
                            @endphp
                            {!! $description !!}
                        </td>
                        <td class="">
